...
/* harmony export */   "Script": () => /* reexport safe */ _pali_script__WEBPACK_IMPORTED_MODULE_0__.Script,
/* harmony export */   "TextProcessor": () => /* reexport safe */ _pali_script__WEBPACK_IMPORTED_MODULE_0__.TextProcessor,
/* harmony export */   "getScriptForCode": () => /* reexport safe */ _pali_script__WEBPACK_IMPORTED_MODULE_0__.getScriptForCode,
/* harmony export */   "lao_conso_range": () => /* reexport safe */ _pali_script__WEBPACK_IMPORTED_MODULE_0__.lao_conso_range,
/* harmony export */   "mymr_conso_range": () => /* reexport safe */ _pali_script__WEBPACK_IMPORTED_MODULE_0__.mymr_conso_range,
/* harmony export */   "paliScriptInfo": () => /* reexport safe */ _pali_script__WEBPACK_IMPORTED_MODULE_0__.paliScriptInfo,
/* harmony export */   "sinh_conso_range": () => /* reexport safe */ _pali_script__WEBPACK_IMPORTED_MODULE_0__.sinh_conso_range,
/* harmony export */   "thai_conso_range": () => /* reexport safe */ _pali_script__WEBPACK_IMPORTED_MODULE_0__.thai_conso_range
/* harmony export */ });
...
function convert_from(text, script) {
  ...
  var hashMaps = prepareHashMaps(script_index[script], script_index[Script.SI]); // console.log(hashMaps);
...
var TextProcessor = /*#__PURE__*/function () {
  ...
  _createClass(TextProcessor, null, [{
    ...
    value: function basicConvert(input, script) {
      var text = input;
    ...
    value: function basicConvertFrom(input, script) {
      var text = input;
    ...
    key: "convert",
    value: function convert(input, script) {
      var text = input;
    ...
    key: "convertFrom",
    value: function convertFrom(input, script) {
      var text = input;
