(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("pali-script-converter", [], factory);
	else if(typeof exports === 'object')
		exports["pali-script-converter"] = factory();
	else
		root["pali-script-converter"] = factory();
...
/* harmony export */   "Script": () => /* reexport safe */ _pali_script__WEBPACK_IMPORTED_MODULE_2__.Script,
/* harmony export */   "TextProcessor": () => /* reexport safe */ _pali_script__WEBPACK_IMPORTED_MODULE_2__.TextProcessor,
/* harmony export */   "getScriptForCode": () => /* reexport safe */ _pali_script__WEBPACK_IMPORTED_MODULE_2__.getScriptForCode,
/* harmony export */   "paliScriptInfo": () => /* reexport safe */ _pali_script__WEBPACK_IMPORTED_MODULE_2__.paliScriptInfo
/* harmony export */ });
/* harmony import */ var _obj2__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./obj2 */ "./src/obj2.js");
/* harmony import */ var _obj1__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./obj1 */ "./src/obj1.js");
/* harmony import */ var _pali_script__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./pali-script */ "./src/pali-script.js");


/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  Obj1: _obj1__WEBPACK_IMPORTED_MODULE_1__.default,
  Obj2: _obj2__WEBPACK_IMPORTED_MODULE_0__.default
});
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => /* binding */ Obj1
/* harmony export */ });
...
var _script_index, _beautify_func, _un_beautify_func, _convert_to_func, _convert_from_func;
...
var paliScriptInfo = new Map([[Script.SI, ['Sinhala', 'සිංහල', [[0x0D80, 0x0DFF]], {
  f: 'sl_flag.png'
}]], [Script.HI, ['Devanagari', 'हिन्दी', [[0x0900, 0x097F]], {
  f: 'in_flag.png'
...
var script_index = (_script_index = {}, _script_index[Script.SI] = 0, _script_index[Script.HI] = 1, _script_index[Script.RO] = 2, _script_index[Script.THAI] = 3, _script_index[Script.LAOS] = 4, _script_index[Script.MY] = 5, _script_index[Script.KM] = 6, _script_index[Script.BENG] = 7, _script_index[Script.GURM] = 8, _script_index[Script.THAM] = 9, _script_index[Script.GUJA] = 10, _script_index[Script.TELU] = 11, _script_index[Script.KANN] = 12, _script_index[Script.MALA] = 13, _script_index[Script.BRAH] = 14, _script_index[Script.TIBT] = 15, _script_index[Script.CYRL] = 16, _script_index);
var specials = [// independent vowels
['අ', 'अ', 'a', 'อ', 'ອ', 'အ', 'អ', 'অ', 'ਅ', "\u1A4B", 'અ', 'అ', 'ಅ', 'അ', '𑀅', 'ཨ', 'а'], ['ආ', 'आ', 'ā', 'อา', 'ອາ', 'အာ', 'អា', 'আ', 'ਆ', "\u1A4C", 'આ', 'ఆ', 'ಆ', 'ആ', '𑀆', 'ཨཱ', 'а̄'], ['ඉ', 'इ', 'i', 'อิ', 'ອິ', 'ဣ', 'ឥ', 'ই', 'ਇ', "\u1A4D", 'ઇ', 'ఇ', 'ಇ', 'ഇ', '𑀇', 'ཨི', 'и'], ['ඊ', 'ई', 'ī', 'อี', 'ອີ', 'ဤ', 'ឦ', 'ঈ', 'ਈ', "\u1A4E", 'ઈ', 'ఈ', 'ಈ', 'ഈ', '𑀈', 'ཨཱི', 'ӣ'], ['උ', 'उ', 'u', 'อุ', 'ອຸ', 'ဥ', 'ឧ', 'উ', 'ਉ', "\u1A4F", 'ઉ', 'ఉ', 'ಉ', 'ഉ', '𑀉', 'ཨུ', 'у'], ['ඌ', 'ऊ', 'ū', 'อู', 'ອູ', 'ဦ', 'ឩ', 'ঊ', 'ਊ', "\u1A50", 'ઊ', 'ఊ', 'ಊ', 'ഊ', '𑀊', 'ཨཱུ', 'ӯ'], ['එ', 'ए', 'e', 'อเ', 'ອເ', 'ဧ', 'ឯ', 'এ', 'ਏ', "\u1A51", 'એ', 'ఏ', 'ಏ', 'ഏ', '𑀏', 'ཨེ', 'е'], ['ඔ', 'ओ', 'o', 'อโ', 'ອໂ', 'ဩ', 'ឱ', 'ও', 'ਓ', "\u1A52", 'ઓ', 'ఓ', 'ಓ', 'ഓ', '𑀑', 'ཨོ', 'о'], // various signs
...
['ා', 'ा', 'ā', 'า', 'າ', 'ာ', 'ា', 'া', 'ਾ', "\u1A63", 'ા', 'ా', 'ಾ', 'ാ', '𑀸', "\u0F71", 'а̄'], ['ි', 'ि', 'i', "\u0E34", "\u0EB4", 'ိ', 'ិ', 'ি', 'ਿ', "\u1A65", 'િ', 'ి', 'ಿ', 'ി', '𑀺', "\u0F72", 'и'], ['ී', 'ी', 'ī', "\u0E35", "\u0EB5", 'ီ', 'ី', 'ী', 'ੀ', "\u1A66", 'ી', 'ీ', 'ೀ', 'ീ', '𑀻', "\u0F71\u0F72", 'ӣ'], ['ු', 'ु', 'u', "\u0E38", "\u0EB8", 'ု', 'ុ', 'ু', 'ੁ', "\u1A69", 'ુ', 'ు', 'ು', 'ു', '𑀼', "\u0F74", 'у'], ['ූ', 'ू', 'ū', "\u0E39", "\u0EB9", 'ူ', 'ូ', 'ূ', 'ੂ', "\u1A6A", 'ૂ', 'ూ', 'ೂ', 'ൂ', '𑀽', "\u0F71\u0F74", 'ӯ'], ['ෙ', 'े', 'e', 'เ', 'ເ', 'ေ', 'េ', 'ে', 'ੇ', "\u1A6E", 'ે', 'ే', 'ೇ', 'േ', '𑁂', "\u0F7A", 'е'], //for th/lo - should appear in front
...
function un_beautify_sinh(text) {
...
function beautify_mymr(text, script, rendType) {
  if (rendType === void 0) {
    rendType = '';
  }
...
function un_beautify_mymr(text) {
...
function convert_to(text, script) {
  var hashMaps = prepareHashMaps(script_index[Script.SI], script_index[script]);
  return replaceByMaps(text, hashMaps);
}

function convert_from(text, script) {
  var hashMaps = prepareHashMaps(script_index[script], script_index[Script.SI]); // TODO create maps initially and reuse them
...
function convert_from_w_v(text, script) {
  var hashMaps = prepareHashMaps(script_index[script], script_index[Script.SI], false); // without vowels for roman
...
var TextProcessor = /*#__PURE__*/function () {
  ...
  _createClass(TextProcessor, null, [{
    ...
    value: function basicConvert(text, script) {
      (convert_to_func[script] || convert_to_func_default).forEach(function (func) {
        return text = func(text, script);
      });
      return text;
    } // convert from another script to sinhala

  }, {
    key: "basicConvertFrom",
    value: function basicConvertFrom(text, script) {
    ...
    key: "beautify",
    value: function beautify(text, script, rendType) {
      if (rendType === void 0) {
        rendType = '';
      }

      (beautify_func[script] || beautify_func_default).forEach(function (func) {
        return text = func(text, script, rendType);
      });
      return text;
    ...
    key: "convert",
    value: function convert(text, script) {
    ...
    key: "convertFrom",
    value: function convertFrom(text, script) {
    ...
    value: function convertFromMixed(mixedText) {
...
//# sourceMappingURL=pali-script-converter.js.map