...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  convertAny: _pali_script_extensions__WEBPACK_IMPORTED_MODULE_1__.convertAny,
...
/* harmony export */   "convertAny": () => /* binding */ convertAny,
...
var convert = function convert(input, fromScript, toScript) {
  var sinh = _pali_script__WEBPACK_IMPORTED_MODULE_0__.TextProcessor.convertToSinh(input, fromScript);
  return _pali_script__WEBPACK_IMPORTED_MODULE_0__.TextProcessor.convertFromSinh(sinh, toScript);
};
var convertAny = function convertAny(input, toScript) {
  var sinh = _pali_script__WEBPACK_IMPORTED_MODULE_0__.TextProcessor.convertAnyToSinh(input);
  return _pali_script__WEBPACK_IMPORTED_MODULE_0__.TextProcessor.convertFromSinh(sinh, toScript);
};
...
var beautify_func = (_beautify_func = {}, _beautify_func[Script.SI] = [beautify_sinh, beautify_common], _beautify_func[Script.RO] = [beautify_common], _beautify_func[Script.THAI] = [swap_e_o, beautify_thai, beautify_common], _beautify_func[Script.LAOS] = [swap_e_o, beautify_common], _beautify_func[Script.MY] = [beautify_mymr, beautify_common], _beautify_func[Script.KM] = [beautify_common], _beautify_func[Script.THAM] = [beautify_tham], _beautify_func[Script.GUJA] = [beautify_common], _beautify_func[Script.TELU] = [beautify_common], _beautify_func[Script.MALA] = [beautify_common], _beautify_func[Script.BRAH] = [beautify_brahmi, beautify_common], _beautify_func[Script.TIBT] = [beautify_tibet], _beautify_func[Script.CYRL] = [beautify_common], _beautify_func); // when converting from another script, have to unbeautify before converting

var un_beautify_func_default = [];
var un_beautify_func = (_un_beautify_func = {}, _un_beautify_func[Script.SI] = [cleanup_zwj, un_beautify_sinh], _un_beautify_func[Script.HI] = [cleanup_zwj], _un_beautify_func[Script.THAI] = [un_beautify_thai, un_swap_e_o], _un_beautify_func[Script.LAOS] = [un_swap_e_o], _un_beautify_func[Script.KM] = [un_beautify_khmer], _un_beautify_func[Script.MY] = [un_beautify_mymr], _un_beautify_func[Script.TIBT] = [un_beautify_tibet], _un_beautify_func);
...
var TextProcessor = /*#__PURE__*/function () {
  ...
  _createClass(TextProcessor, null, [{
    ...
    key: "convertAnyToSinh",
    value: function convertAnyToSinh(input) {
      var mixedText = input;
