...
[Script.RO, ['Roman', 'English', [[0x0000, 0x017f], [0x1e00, 0x1eff]], {
  f: 'uk_flag.png',
  locale: 'en'
...
[Script.THAI, ['Thai', 'ไทย', [[0x0e00, 0x0e7f], 0xf70f, 0xf700], {
  ...
  locale: 'ml',
  g: 'indian'
}]], [Script.THAM, ['Tai Tham', 'ไทย (Lana)', [[0x1a20, 0x1aaf]], {
  locale: 'th',
  c: 'beta-script',
  g: 'other'
}]], // charCodeAt returns two codes for each letter [[0x11000, 0x1107F]]
[Script.BRAH, ['Brahmi', 'हिन्दी (Brah)', [[0xd804, 0xd804], [0xdc00, 0xdc7f]], {
  locale: 'hi',
  g: 'other'
...
[Script.CYRL, ['Cyrillic', 'ру́сский', [[0x0400, 0x04ff], [0x0300, 0x036f]], {
  f: 'russia_flag.png',
  locale: 'ru',
  g: 'other'
}]]]);
